...
class MobileNetV3(nn.Module):
    ...
    def forward(self, x: Tensor, other=None) -> Tensor:
...
def mobilenet_v3_large_our(
    *, weights: Optional[MobileNet_V3_Large_Weights] = "MobileNet_V3_Large_Weights", progress: bool = True, pretrained=True, pretrained_model_path=None, batch_norm='basic', with_film=False, **kwargs: Any
) -> MobileNetV3:
    """
    ...
    if pretrained:
        if pretrained_model_path:
            weights = MobileNet_V3_Large_Weights.load_from_path(pretrained_model_path)
        else:
            weights = MobileNet_V3_Large_Weights.DEFAULT  # or some other default logic

        weights = MobileNet_V3_Large_Weights.verify(weights)

    
    print('WEIGHTSSSSSS', weights)    
